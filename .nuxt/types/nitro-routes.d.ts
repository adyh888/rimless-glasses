...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/articles/batch': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/articles/batch.post').default>>>>
    }
    '/api/articles/import': {
    ...
    '/api/products/batch': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/products/batch.post').default>>>>
    }
    '/api/products': {
